//no longer used. see fusion_tables.js
$(function () {
  var chartTrend;
  var chartRaw;
  var chartSeason;
  ...
  chartRaw = ChartHelper.create('businessLicenseRaw', 'Monthly Count of New Business Licenses', source, 'Issued business licenses', '#c30c30', rawData, startDate, 'month');
  ...
  chartSeason = ChartHelper.create('businessLicenseSeason', 'Seasonal Effect on New Business Licenses', source, 'Seasonal effect', '#C09853', seasonData, startDate, 'month');
  
  var unemploymentData = [7.5,7.3,7,7.4,7,7.3,7.4,7.5,7.4,6.8,6.9,7,7.8,7.6,7.9,7.5,7.7,8.4,8.1,8.2,8.2,8.5,9.1,9.4,9.8,9.7,9.3,9.1,9.4,9.9,9.2,8.3,8,7.2,7.7,8.1,8.8,8.8,8.7,8.8,9.1,9.4,8.9,8.3,8.6,8,7.3,7.1,8.3,7.6,7.3,6.9,6.5,6.6,6.5,6.2,5.9,5.8,5.3,4.9,5.9,5.6,5.6,6.2,5.9,5.8,6,6,5.8,5.4,5.3,5.5,6.4,5.9,5.9,6,6.2,6.2,6.3,5.8,5.6,5.2,5.3,5.5,6,5.7,5.7,5.3,5,5.4,5.3,5,5.2,5,5.1,5.1,5.7,5.1,5.1,4.4,4.5,5.4,4.9,4.9,5.2,4.9,4.9,4.7,5,4.9,4.5,5,5.2,5.7,5.6,5.1,4.9,4.7,4.7,4.5,4.8,4.9,5,4.6,4.7,5.1,5.2,4.9,4.7,4.2,4.8,5.1,5.8,5.7,6.1,5.9,5.6,6.3,6.1,6.1,5.9,5.9,6.5,6.7,7.5,7.2,7.5,7.5,7.3,8,8.1,7.4,7.1,7.1,7.3,7.1,7.6,7.4,7.4,7.1,7.2,8.4,7.9,7.7,7.5,6.8,6.9,6.5,7.2,6.7,6.9,6.7,6.8,7.1,7.1,6.7,6.4,6.4,6.5,6.2,6.7,7,6.6,6.8,6.7,7.2,6.8,6.2,6.2,5.6,5.6,5.5,5.6,5.3,5.1,5,4.7,5.1,5.1,4.8,4.4,3.9,4.1,4.2,5.1,4.9,4.5,5,5.1,5.8,5.7,5.4,5.2,5.1,5.1,5.3,5.9,5.6,5.5,5.4,6.4,7.1,7.1,6.9,6.5,6.7,6.8,7.4,8.5,9.1,9.5,9.9,10.6,11.2,11,10.6,10.9,11.1,11,11.1,12.1,11.7,11.5,11.2,11.1,11.2,11.1,10.5,10.1,9.8,10,9.5,10.1,9.7,9.6,9.8,10.6,11.3,11.4,11.1,10.7,10.4,10,9.7,9.8,9,9.2,9.3,9,9.8,];
  
  chartUnemployment = ChartHelper.create('unemployment', 'Monthly Unemployment Rate', "Cook County, IL", 'Unemployment rate (%)', '#7C54FB', unemploymentData, Date.UTC(1990, 0, 28), 'month');
}); 
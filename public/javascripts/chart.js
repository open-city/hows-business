$(function () {
  ...
  $(document).ready(function() {
    chartTrend = new Highcharts.Chart({
      chart: {
  ...
  $(document).ready(function() {
    chartRaw = new Highcharts.Chart({
      ...
      title: {
          text: 'Monthly Count of New Business Licenses',
          x: -20 //center
      },
      subtitle: {
          text: 'Source: City of Chicago',
  ...
  var chartSeason;
  $(document).ready(function() {
    chartSeason = new Highcharts.Chart({
      chart: {
          renderTo: 'businessLicenseSeason',
          type: 'line',
          marginRight: 130,
          marginBottom: 25
      },
      ...
      title: {
          text: 'Seasonal Effect on New Business Licenses',
          x: -20 //center
      },
      subtitle: {
          text: 'Source: City of Chicago',
